...
describe("Error", function()
  ...
  describe("error_mt", function()
    ...
    it("should have a __tostring metamethod", function()
      ...
      assert.equal("fixture: bar", tostring(some_err))
    end)
    it("should have a __concat metamethod", function()
      ...
      assert.equal("test fixture: bar", "test "..some_err)
      assert.equal("fixture: bar test", some_err.." test")
    end)
  end)
  describe("NoHostAvailableError", function()
    ...
    it("should accept a table", function()
      local err = Errors.NoHostAvailableError({["127.0.0.1"] = "DOWN", ["127.0.0.2"] = "DOWN"})
      assert.equal("NoHostAvailableError", err.type)
      assert.equal("All hosts tried for query failed. 127.0.0.1: DOWN. 127.0.0.2: DOWN.", err.message)
    end)
  end)
